...
Προκειμένου να επιτευχθεί ο συγχρονισμός μεταξύ των μηνυμάτων, ο master node προγραμματίστηκε να κάνει broadcast τακτικά, πακέτα τύπου master_time (βλ, μέρος του πακέτου της \Fig{proprietary-msg}) με το ρολόι το οποίο έχει αυτός. Όταν τα worker nodes λάβουν αυτήν την πληροφορία, την αποθηκεύουν σε εσωτερικό buffer, πραγματοποιούν το detection και localization  
...
\section{Επαλήθευση ID του detected object}
Για λόγους πληρότητας, καθώς και επαλήθευσης του detection, ως τελευταίο κομμάτι του συστήματος, προτείνεται ένας τρόπος ώστε να δια 
