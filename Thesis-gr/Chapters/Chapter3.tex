...
Από την οποία καταλήγουμε στο \Equa{distance-from-object}. Όπου στο μέγεθος του α\-ντι\-κει\-μέ\-νου μπορούμε να χρησιμοποιήσουμε οποιαδήποτε διάσταση επιθυμούμε, όπως το ύψος, το πλάτος ή ακόμα και κάποια διαγώνιο του.
