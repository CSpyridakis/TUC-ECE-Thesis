\begin{abbreviations}{ll} % Run $make fixAbbr, to automatically sort them
    ...
    % \CreateAbbr{ROI}	   		{\textbf{R}egion \textbf{O}F \textbf{I}nterest}
    \CreateAbbr{2D}			{\textbf{2} \textbf{D}imensional}
    \CreateAbbr{3D}			{\textbf{3} \textbf{D}imensional}
    \CreateAbbr{AFOV}		{\textbf{A}ngular \textbf{F}ield \textbf{O}f \textbf{V}iew}
    ...
    \CreateAbbr{FOV}		{\textbf{F}ield \textbf{O}f \textbf{V}iew}
    ...
    \CreateAbbr{I2C}		{\textbf{I}nter-\textbf{I}ntegrated \textbf{C}ircuit}
    ...
    \CreateAbbr{IR}		    {\textbf{I}nf\textbf{r}ared}
    ...
    \CreateAbbr{MOOC}		{\textbf{M}assive \textbf{O}pen \textbf{O}nline \textbf{C}ourse}
    ...
    \CreateAbbr{OpenCV}		{\textbf{Open} Source \textbf{C}omputer \textbf{V}ision}
