...
\begin{align}
	(x-x_1)^2 + (y-y_1)^2 + (z-z_1)^2 &= r_1^2 - e_1 \label{eq:multilateration-pha1} \\ 
	(x-x_2)^2 + (y-y_2)^2 + (z-z_2)^2 &= r_2^2 - e_2 \nonumber \\
	(x-x_3)^2 + (y-y_3)^2 + (z-z_3)^2 &= r_3^2 - e_3 \nonumber \\
	(x-x_4)^2 + (y-y_4)^2 + (z-z_4)^2 &= r_4^2 - e_4 \nonumber 
\end{align}

\begin{align}
	(x^2+y^2+z^2) - 2x_1x - 2y_1y - 2z_1z &= r_1^2 - x_1^2 - y_1^2 - z_1^2- e_1 \label{eq:multilateration-pha2} \\ 
	(x^2+y^2+z^2) - 2x_2x - 2y_2y - 2z_2z &= r_2^2 - x_2^2 - y_2^2 - z_2^2- e_2 \nonumber \\
	(x^2+y^2+z^2) - 2x_3x - 2y_3y - 2z_3z &= r_3^2 - x_3^2 - y_3^2 - z_3^2- e_3 \nonumber \\
	(x^2+y^2+z^2) - 2x_4x - 2y_4y - 2z_4z &= r_4^2 - x_4^2 - y_4^2 - z_4^2- e_4 \nonumber
\end{align}
...
\begin{align}
	...
	B = \begin{bmatrix} r_1^2 - x_1^2 - y_1^2 - z_1^2- e_1 \\ r_2^2 - x_2^2 - y_2^2 - z_2^2- e_2 \\ r_3^2 - x_3^2 - y_3^2 - z_3^2- e_3 \\ r_4^2 - x_4^2 - y_4^2 - z_4^2- e_4 \end{bmatrix} \nonumber
\end{align}
