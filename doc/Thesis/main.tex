...
\newcommand{\udot}{$^{\mbox{\textbf{$\cdot$}}}$ }
...
\keywords{Drones, Swarm, Swarm of Drones, WSN, Wireless Sensor Networks, Fleet of Drones, Angle of Arrival, AOA, Direction of Arrival, DOA, Multilateration, Trilateration, Triangulation, Bounding Box, Received Signal Strength Indicator, RSSI, Time Difference of Arrival, TDOA, Time of Arrival, TOA, Unmanned Aircraft System, UAS, Unmanned Aerial Vehicle, UAV} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\begin{abbreviations}{ll} % Include a list of abbreviations (a table of two columns)]
	...
	\textbf{DV-Hop}	& \textbf{D}istance \textbf{V}ector \textbf{H}op \label{abbr:DV-Hop} \\ % USED
	...
	\textbf{FANET}	& \textbf{F}Flying \textbf{A}d-hoc \textbf{NET}work \label{abbr:FANET} \\ % USED
