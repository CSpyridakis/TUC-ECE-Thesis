...
\usepackage{default} % Use the Palatino font by default
%%%% apo edw allazei pws 8a fainetai ta references
...
\thesistitle{Design and Implementation of an FPGA-Based Convolutional Neural Network Accelerator} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\degree{DIPLOMA THESIS} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
\author{Christos Spyridakis} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\group{\href{http://www.mhl.tuc.gr/ }{Microprocessor and Hardware Lab}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\vspace*{.025 \textheight} %.025 \textheight
{\scshape\LARGE \univname\par}\vspace{0.7cm} % Technical University of Crete
...
\begin{minipage}[t]{0.6\textwidth}
    \begin{flushright} \large
        ...
        \href{https://www.ece.tuc.gr/index.php?id=4531&tx_tuclabspersonnel_list%5Bperson%5D=289&tx_tuclabspersonnel_list%5Baction%5D=person&tx_tuclabspersonnel_list%5Bcontroller%5D=List}{Prof. Apostolos Dollas (Supervisor)}\\ % Supervisor name - remove the \href bracket to remove the link  
...
\includegraphics[scale=0.21]{Images/Tech_Crete.png} % University/department logo - uncomment to place it
\\[0.5cm]

\large \textit{A thesis submitted in fulfillment of the requirements\\ for the DIPLOMA of Electrical and Computer Engineering}\\[0.1cm] % University requirement text
\textit{in the}\\[0.1cm]
\deptname\\\groupname\\[0.4cm] % Research group name and department name
 


{\large \printdate}\\[2cm] % Date
