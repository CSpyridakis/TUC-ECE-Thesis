...
\begin{abbreviations}{ll} % Include a list of abbreviations (a table of two columns)]
	...
	% \textbf{D{	& \textbf{D}irect \textbf{P}ath \label{abbr:DP} \\ 
	...
	% \textbf{E{	& \textbf{E}lectrο\textbf{m}agnetic \label{abbr:EM} \\ 
	...
	% \textbf{G{	& \textbf{G}lobal \textbf{I}nformation \label{abbr:GI} \\ 
	...
	\CreateAbbr{LPS}		{\textbf{L}ocal \textbf{P}ositioning \textbf{S}ystem \textbf{A}rea \textbf{N}etwork}
	...
	\CreateAbbr{S\&R}[SR]	{\textbf{S}earch \textbf{\&} \textbf{R}escue}
