...
\newcommand{\Fig}[1]{\emph{Figure} \ref{#1}}
\newcommand{\Tabl}[1]{\emph{Table} \ref{#1}}
\newcommand{\Eque}[1]{\emph{Equation} \ref{#1}}
\newcommand{\Chap}[1]{\emph{Chapter} \ref{#1}}
\newcommand{\Sect}[1]{\emph{Section} \ref{#1}}
...
\keywords{Drones, Swarm, Swarm of Drones, 
	...
	TDOA, Time of Arrival, TOA, Unmanned Aircraft System, UAS, Unmanned Aerial Vehicle, UAV} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\begin{abbreviations}{ll} % Include a list of abbreviations (a table of two columns)]
	...
	\textbf{AHD}	& \textbf{A}verage \textbf{H}op \textbf{D}istance \label{abbr:AHD} \\ % USED
	\textbf{AHRS}	& \textbf{A}ltitude \textbf{H}eading \textbf{R}eference \textbf{S}ystem \label{abbr:AHRS} \\ % USED
	\textbf{APIT}	& \textbf{A}pproximate \textbf{P}oint \textbf{I}n \textbf{T}riangle \label{abbr:APIT} \\ % USED
	\textbf{BP}		& \textbf{B}elief \textbf{P}ropagation \label{abbr:BP} \\ % USED  
	\textbf{BS}		& \textbf{B}ase \textbf{S}tation \label{abbr:BS} \\ % USED
	\textbf{CIF}	& \textbf{C}ovariance \textbf{I}ntersection \textbf{F}ilter \label{abbr:CIF} \\ % USED    
	\textbf{CL}		& \textbf{C}ooperative \textbf{L}ocalization \label{abbr:CL} \\ % USED
	\textbf{DoA}	& \textbf{D}irection \textbf{o}f \textbf{A}rrival \label{abbr:DoA} \\ % USED
	\textbf{DoF}	& \textbf{D}egrees \textbf{o}f \textbf{F}reedom \label{abbr:DoF} \\ % USED
	% \textbf{DP}		& \textbf{D}irect \textbf{P}ath \label{abbr:DP} \\ 
	\textbf{DV-Hop}	& \textbf{D}istance \textbf{V}ector-\textbf{Hop} \label{abbr:DV-Hop} \\ % USED
	% \textbf{ECEF}	& \textbf{E}arth \textbf{C}entered \textbf{E}arth \textbf{F}ixed \label{abbr:ECEF} \\
	\textbf{EKF}	& \textbf{E}xtended \textbf{K}alman \textbf{F}ilter \label{abbr:EKF} \\
	% \textbf{EM}		& \textbf{E}lectrο\textbf{m}agnetic \label{abbr:EM} \\ 
	\textbf{ESC}	& \textbf{E}lectronic \textbf{S}peed \textbf{C}ontrol \label{abbr:ESC} \\ % USED
	\textbf{FANET}	& \textbf{F}lying \textbf{A}d-hoc \textbf{Net}work \label{abbr:FANET} \\ % USED
	...
	% \textbf{GI}		& \textbf{G}lobal \textbf{I}nformation \label{abbr:GI} \\ 
	...
	\textbf{IC}		& \textbf{I}ntegrated  \textbf{C}ircuit  \label{abbr:IC} \\ % USED
	...
	\textbf{KF}		&\textbf{K}alman \textbf{F}ilter \label{abbr:KF} \\ % USED
	\textbf{LBSA}	& \textbf{L}ocalization \textbf{B}ased on \textbf{S}imulated \textbf{A}nnealing \label{abbr:LBSA} \\ % USED
	\textbf{LoS}	& \textbf{L}ine   \textbf{o}f \textbf{S}ight \label{abbr:LoS} \\ % USED
	\textbf{LPS}	& \textbf{L}ocal \textbf{P}ositioning \textbf{S}ystem \textbf{A}rea \textbf{N}etwork \label{abbr:LPS} \\ % USED
	...
	\textbf{MDS-MAP}& \textbf{M}ulti \textbf{D}imensional \textbf{S}caling-\textbf{M}obile \textbf{A}ssisted \textbf{P}rogramming\label{abbr:MDS-MAP} \\ % USED
	...
	\textbf{NED}	& \textbf{N}orth \textbf{E}ast \textbf{D}own \label{abbr:NED} \\ % USED
	\textbf{NLoS}	& \textbf{N}on-\textbf{L}ine \textbf{o}f \textbf{S}ight \label{abbr:NLoS} \\ % USED
	% \textbf{PSO}	& \textbf{P}article \textbf{S}warm \textbf{O}ptimization \label{abbr:PSO} \\
	\textbf{PBR}	& \textbf{P}assive \textbf{B}istatic \textbf{R}adar \label{abbr:PBR} \\
	\textbf{PSL}	& \textbf{P}assive \textbf{S}ource \textbf{L}ocation \label{abbr:PSL} \\
	\textbf{RF}	    & \textbf{R}adio \textbf{F}requency \label{abbr:RF} \\ % USED
	% \textbf{RMSE}	& \textbf{R}oot \textbf{M}ean \textbf{S}quare \textbf{E}rror \label{abbr:RMSE} \\
	...
	\textbf{RTT}	& \textbf{R}ound-\textbf{T}rip \textbf{T}ime \label{abbr:RTT} \\ % USED
	\textbf{SCIF}	& \textbf{S}plit \textbf{C}ovariance \textbf{I}ntersection \textbf{F}ilter \label{abbr:SCIF} \\ % USED
	\textbf{SR}		& \textbf{S}warm \textbf{R}obotics \label{abbr:SR} \\ % USED
	\textbf{S\&R}	& \textbf{S}earch \textbf{\&} \textbf{R}escue \label{abbr:SnR} \\ % USED
	\textbf{SDP}	& \textbf{S}emi \textbf{D}efinite \textbf{P}rogramming \label{abbr:SDP} \\ % USED
	% \textbf{SDS-TWR}& \textbf{S}ymmetrical \textbf{D}ouble-\textbf{S}ided \textbf{T}wo-\textbf{W}ay \textbf{R}anging \label{abbr:SDS-TWR} \\
	\textbf{SS-TWR} & \textbf{S}ingle-\textbf{S}ided \textbf{T}wo-\textbf{W}ay \textbf{R}anging \label{abbr:SS-TWR} \\ % USED
	...
	\textbf{UKF}	& \textbf{U}nscented \textbf{K}alman \textbf{F}ilter \label{abbr:UKF} \\ % USED
