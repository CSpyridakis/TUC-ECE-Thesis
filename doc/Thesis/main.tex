...
\begin{abbreviations}{ll} % Include a list of abbreviations (a table of two columns)]
	...
	% \textbf{ECEF}	& \textbf{E}arth \textbf{C}Centered \textbf{E}arth \textbf{F}ixed \label{abbr:ECEF} \\
	% \textbf{EKF}	& \textbf{E}extended \textbf{K}alman \textbf{F}ilters \label{abbr:EKF} \\
	...
	% \textbf{UWB}	& \textbf{U}ltra-\textbf{w}ideband \label{abbr:UWB} \\
