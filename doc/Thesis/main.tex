...
\begin{abbreviations}{ll} % Include a list of abbreviations (a table of two columns)]
	\textbf{MCU}	& \textbf{M}icro \textbf{C}ontroller \textbf{U}nit \label{abrr:MCU} \\ 
	\textbf{MPU}	& \textbf{M}icro \textbf{P}rocessor \textbf{U}nit \label{abrr:MPU} \\
	\textbf{UAV}	& \textbf{U}nmanned \textbf{A}erial \textbf{V}ehicle \label{abrr:UAV} \\
	\textbf{VTOL}	& \textbf{V}ertically \textbf{H}over, \textbf{T}ake-off, and \textbf{L}and \label{abrr:VTOL} \\
	\textbf{ESC}	& \textbf{E}lectronic \textbf{S}peed \textbf{C}ontrol \label{abrr:ESC} \\
	\textbf{IMU}	& \textbf{I}ntertial \textbf{M}easurement \textbf{U}nit \label{abrr:IMU} \\
	\textbf{GPS}	& \textbf{G}lobal \textbf{P}ositioning \textbf{S}ystem \label{abrr:GPS} \\
	\textbf{FPV}	& \textbf{F}irst \textbf{P}erson \textbf{V}iew \label{abrr:FPV} \\
	\textbf{WSN}	& \textbf{W}ireless \textbf{S}ensor \textbf{N}etworks \label{abrr:WSN} \\
	\textbf{UGV}	& \textbf{U}nmanned \textbf{G}round \textbf{V}ehicle \label{abrr:UGV} \\
	\textbf{MAV}	& \textbf{M}icro \textbf{A}erial \textbf{V}ehicle \label{abrr:MAV} \\
	\textbf{USV}	& \textbf{U}nmanned \textbf{S}urface \textbf{V}ehicle \label{abrr:USV} \\
	\textbf{UAS}	& \textbf{U}nmanned \textbf{A}ircraft \textbf{S}ystems \label{abrr:UAS} \\
	\textbf{ISR}	& \textbf{I}ntelligence, \textbf{S}urveillance, and \textbf{R}econnaissance \label{abrr:ISR} \\
	\textbf{UCAV}	& \textbf{U}nmanned \textbf{C}ombat \textbf{A}erial \textbf{V}ehicle \label{abrr:} \\
	\textbf{}	& \textbf{} \textbf{} \textbf{} \label{abrr:} \\
	\textbf{}	& \textbf{} \textbf{} \textbf{} \label{abrr:} \\
