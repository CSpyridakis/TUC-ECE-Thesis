...
\usepackage{default} % Use the Palatino font by default [default or mathpazo]
...
\begin{titlepage}
	\begin{center}
		...
		{\scshape\LARGE \univname\par}\vspace{0.7cm} % University name
		...
		\begin{minipage}[t]{0.58\textwidth}
			\begin{flushright} \large
				...
				% Todo: fill correct link
				\href{https://www.ece.tuc.gr/index.php?id=4531&tx_tuclabspersonnel_list%5Bperson%5D=289&tx_tuclabspersonnel_list%5Baction%5D=person&tx_tuclabspersonnel_list%5Bcontroller%5D=List}{\supname (Supervisor)}\\ % Supervisor name - remove the \href bracket to remove the link
