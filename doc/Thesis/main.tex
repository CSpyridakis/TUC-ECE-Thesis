...
\begin{abbreviations}{ll} % Include a list of abbreviations (a table of two columns)]
	...
	\textbf{VTOL}	& \textbf{V}ertically \textbf{H}over, \textbf{T}ake-off, and \textbf{L}and\\
	\textbf{ESC}	& \textbf{E}lectronic \textbf{S}peed \textbf{C}ontrol\\
	\textbf{IMU}	& \textbf{I}ntertial \textbf{M}easurement \textbf{U}nit\\
	\textbf{GPS}	& \textbf{G}lobal \textbf{P}ositioning \textbf{S}ystem\\
	\textbf{FPV}	& \textbf{F}irst \textbf{P}erson \textbf{V}iew\\
