...
% usb\_cam για να πάρουμε την εικόνα
% ros packages vision\_opencv το οποίο είναι metapackage που περιέχει τα πακέτα cv\_bridge και image\_geometry

% επίσης υπάρχει το image\_transport για το pub\ sub (χρησιμοποιεί compression techniques)
% ------------------
