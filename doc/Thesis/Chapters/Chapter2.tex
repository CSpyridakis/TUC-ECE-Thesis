...
γνώση που έχουμε για γωνίες και όχι εκτίμηση της απόστασης. Μπορεί να γίνει είτε από τοπικές μετρήσεις του ίδιου του node
...
\cite{wsn-Localization-systems} και αξιοποιεί την τριγωνομετρία για τον υπολογισμό της θέσης του free node.
...
Η μέθοδος του Multilateration, έχει ως βάση την γεωμετρία των υπερβολικών καμπύλων και συχνά μπορεί να βρεθεί επίσης και ως hyperbolic positioning 
