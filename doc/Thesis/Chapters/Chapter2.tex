...
Στην υπάρχουσα βιβλιογραφία \cite{wsn-Localization-systems} \cite{wsn-Localization-techniques} \cite{farooqiazam2016location} βρίσκουμε ότι
...
οι χρονική στιγμή που το λάβαμε. Η πρώτη περίπτωση απαιτεί single signal και multiple receivers και παρουσιάζεται στο 
figure \ref{fig:Time-Difference-of-Arrival-cases} (a), 
η οποία χρησιμοποιείται συνήθως στα cellular network - απαιτεί την ύπαρξη 
τουλάχιστον 4 beacons για τον υπολογισμό της θέσης ενός free node στον τρισδιάστατο χώρο, και υπολογίζει την χρονική διαφορά
...
ηχητικό με ταχύτητα $s_s \approx 340m/s$. Με $t_1$ τη χρονική στιγμή που λαμβάνει το \hyperref[abbr:RF]{RF} σήμα, ενώ $t_2$ το ηχητικό.
Με γνώση αυτών των πληροφοριών, μπορούμε να υπολογίσουμε την απόσταση μεταξύ των κόμβων από την εξίσωση (\ref{eq:tdoa-distance})
...
Θετικό σε αυτήν την μέθοδο είναι ότι το error μπορεί να είναι της τάξης των μερικών cm, όμως αρχικά απαιτεί επιπλέον εξοπλισμό στο node -
ώστε να μπορεί να στείλει και να λάβει πολλαπλά είδη σήματος - πράγμα που μπορεί να το κάνει αντιοικονομικό η αρκετά μεγαλύτερο από 
