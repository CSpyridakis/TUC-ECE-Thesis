...
σχέσης (\ref{eq:aoa-equation}) \cite{wsn-Localization-techniques} \cite{youtube-phase-difference-equation}. Παράδειγμα αυτού\udot βρίσκεται στο Figure \ref{fig:Antenna-Arrays} (a).
...
Για αυτό το λόγο, στο παρόν Section παρουσιάζονται επιπλέον πτυχές - του συστήματος - που πρέπει να λάβουμε 
