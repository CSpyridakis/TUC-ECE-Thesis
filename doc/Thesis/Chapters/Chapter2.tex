...
Με αυτόν τον τρόπο η μέτρηση του χρόνο εκκίνησης και άφιξης του σήματος γίνονται στο ίδιο node - 
...
το σήμα που έλαβε και να απαντήσει, αυτός το internal delay μπορεί να είναι είτε γνωστό από 
