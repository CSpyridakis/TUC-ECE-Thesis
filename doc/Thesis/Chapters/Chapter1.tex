...
\FigCaptLabelBasedURL{Images/Introduction/aircraft-principal-axes.png}{UAV principal axes}{UAV-principal-axes}<0.6>(http://www.chrobotics.com/library/understanding-euler-angles)
...
\section{Thesis Outline} \label{sec:Chapter1-4} 
    ...
    \begin{itemize}
        ...
        που προέρχονται από τον ευρύτερο τομέα των Wireless Sensor Networks (\Abbr{WSN}).
