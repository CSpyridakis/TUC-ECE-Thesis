...
\subsection{History and drone types} \label{section:Chapter1-1-1}
%----------------------------------------------------------------------------------------
...
Τα \hyperref[abbr:UAV]{UAV} μαζί με ένα σταθμό βάσης και την
...
\subsection{Characteristics} \label{section:Chapter1-1-2}
...
φυσικά - στον αέρα. Στο Figure \ref{fig:UAV-principal-axes} παρουσιάζονται στους 3 άξονες, οι βαθμοί 
ελευθερίας κίνησης ενός \hyperref[abbr:UAV]{UAV} \cite{aircraft-principal-axes} καθώς και το όνομα
...
Ζούμε σε μία ψηφιακή εποχή, όπου έξυπνες συσκευές γεμάτες με αισθητήρες βρίσκονται γύρω μας. 
Τέτοια τεχνολογικά επιτεύγματα όπως τα drones είναι επίσης εξοπλισμένα με 
...
Με κύριο περιορισμό τα αισθητήρια όργανα να βρίσκονται στο εύρος βάρος του payload που μπορεί να μεταφέρει το drone. 
...
κάλυψη των αναγκών από των individual drones σε μεγαλύτερη κλίμακα, για αυτό μερικές από τις εφαρμογές των drone βρίσκονται
στο Section \ref{sec:Chapter1-2}.
...
%-----------------------------------------------------------------------------------
\subsection{Nature} \label{section:Chapter1-2-1}
...
%-----------------------------------------------------------------------------------
\subsection{Swarms and Applications} \label{section:Chapter1-2-2}
Ένα μεμονωμένο {\hyperref[abbr:UAV]{UAV} σε πολλές περιπτώσεις θα μπορέσει να φέρει εις πέραν την αποστολή 
που του έχει ανατεθεί. 

Ζητήματα αξιοπιστίας όμως μπορούν να δημιουργηθούν πολύ γρήγορα όταν ένα μεμονωμένο drone
...
διαθέτει πολλαπλούς αισθητήρες για να έχουμε πιο λεπτομέρειες δεδομένα σε μία αποστολή, όμως αυτό να είναι αδύνατον διότι 
υπερβαίνουν το δυνατόν βάρος που μπορεί να μεταφέρει
το drone. Η ακόμα και την αποτυχία της αποστολής σε κάποιο malfunction που θα πραγματοποιηθεί στο ιπτάμενου όχημα.
Μπορούμε να πούμε λοιπόν σε μία abstract σύγκριση με αυτή των ζώων, ότι ωθούμαστε για ανάλογους σκοπούς στην χρήση των swarms.  


Για ψυχαγωγικούς σκοπούς, όπως την διεκπεραίωση shows \cite{intel's-shows-around-the-world-and-2018-drones-record}
\cite{ford's-100-drone-show}, 

Για στρατιωτικές επιχειρήσεις,
Unmanned Combat Aerial Vehicle (\hyperref[abbr:UCAV]{UCAV}) \cite{swarm-formation-translation-rotation-attack-demo}

Swarms
\cite{swarm-friendly-communications|brain-sensor-drones|different-swarm-applications|}

Για περισσότερες εφαρμογές ή λεπτομέρειες αυτών, μπορούμε να ανατρέξουμε στην υφιστάμενη βιβλιογραφία 
...
\cite{graph-theory-for-formations|formation-need-from-2001|scalable-solution|complexity-exponentialy-increase|decentralized-way-to-maintain-a-desired-formation}

Links
\cite{moving-models-for-robotic-swarms}
\cite{lab-demo-of-formations-in-3d-movement-with-obstacles}
\cite{lab-demo-control-drone-swarm-with-brain-interface}
\cite{reason-for-working-together|related-swarm-research}
\cite{visual-example-why-swarms-are-important-and-triangulating-for-Unknown-environments-mapping}


\cite{collaborative-operations-in-denied-environment}
\cite{applications|some-research-examples|why-swarm-and-not-single-drone}
\cite{what-is-swarm-robotics}
\cite{military-robots-samples-and-photos}
\cite{UCAVs}
\cite{list-of-uav-applications}

\cite{era-of-drone-swarms}
\cite{drone-swarm-technology}
\cite{drones-mass-destruction}
