...
να συνεργαστούν χρειάζεται πρώτα να μπορούν να ξεπεράσουν τα προβλήματα τα οποία εμφανίζονται.
...
Είναι σημαντικό πριν προχωρήσουμε, να έχει γίνει κατανοητό με τον όρο drone σε τι 
...
είναι μερικά από αυτά \cite{what-is-UAV}
...
Στο Table \ref{tab:drone-determined-by-their-structure} υπάρχει η απλουστευμένη κατηγοριοποίηση η οποία προτάθηκε
...
σύμφωνα με τη βασική μηχανολογική δομή που μπορεί να έχει ένα drone καθώς και τα πλεονεκτήματα ή λόγους χρήσης της κάθε δομής. 
...
Τυπικά τα Fixed-Wing τύπου drones 
Fixed-Wing Hybrid
Single Rotor
Multirotor
...
Όπως και να έχει σε όποια από τις κατηγορίες και αν αντιστοιχεί ένα \hyperref[abbr:UAV]{UAV}
