...
\begin{figure} [H]
	...
	\decoRule
	\caption[UAV principal axe]{\hyperref[abbr:UAV]{UAV} principal axes: \href{http://www.chrobotics.com/library/understanding-euler-angles}{URL}}
...
\cite{intel's-shows-around-the-world-and-2018-drones-record}
...
\cite{research-on-drone-swarms-move-like-animals}
\cite{research-on-drone-swarms-move-like-animals-like-documentary}
...
είναι αρκετά σημαντικό για ένα πολύ μεγάλο πλήθος εφαρμογών.
...
\section{Thesis Outline} \label{sec:Chapter1-4} 
    ...
    \begin{itemize}
        ...
        Σε αυτό το σημείο παρουσιάζεται η διαδικασία σχεδιασμού του ενσωματωμένου συστήματος.
